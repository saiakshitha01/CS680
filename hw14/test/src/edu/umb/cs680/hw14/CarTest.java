...
public class CarTest {
    ...
    public void testYearComparator() {
        ...
        Collections.sort(cars, (Car c1, Car c2) -> Integer.compare(c2.getYear(), c1.getYear()));
    ...
    public void testMileageComparator() {
        ...
        Collections.sort(cars, (Car c1, Car c2) -> Integer.compare(c1.getMileage(), c2.getMileage()));
        assertIterableEquals(expectedOrder, cars);
    }
    ...
    public void testPriceComparator() {
        ...
        List<Car> expectedOrder = List.of(cars.get(0), cars.get(1), cars.get(2));
        Collections.sort(cars, (Car c1, Car c2) -> Float.compare(c1.getPrice(), c2.getPrice()));
        assertIterableEquals(expectedOrder, cars);
    }
    ...
    public void testParetoComparator() {
        ...
        Collections.sort(cars, (Car c1, Car c2) -> Integer.compare(c1.getDominationCount(), c2.getDominationCount()));
        assertIterableEquals(expectedOrder, cars);
    }

...
public class ComparatorTest {
    ...
    public void alphabeticalComparator_ShouldReturnChildrenSortedAlphabetically() {
        LinkedList<FSElement> actual = dir3.getChildren((child1, child2) -> child1.getName().compareTo(child2.getName()));
    ...
    public void alphabeticalComparator_ShouldReturnSubDirectoriesSortedAlphabetically() {
        LinkedList<Directory> actual = dir3.getSubDirectories((child1, child2) -> child1.getName().compareTo(child2.getName()));
    ...
    public void alphabeticalComparator_ShouldReturnFilesSortedAlphabetically() {
        LinkedList<File> actual = dir3.getFiles((child1, child2) -> child1.getName().compareTo(child2.getName()));
    ...
    public void sizeComparator_ShouldReturnChildrenSortedSize() {
        LinkedList<FSElement> actual = dir3.getChildren((child1, child2) -> child1.getSize() - child2.getSize());
        List<FSElement> expected = Arrays.asList(dir4);
        assertIterableEquals(expected, actual);
    }
    ...
    public void sizeComparator_ShouldReturnSubDirectoriesSortedSize() {
        LinkedList<Directory> actual = dir3.getSubDirectories((child1, child2) -> child1.getSize() - child2.getSize());
        List<Directory> expected = Arrays.asList(dir4);
        assertIterableEquals(expected, actual);
    }
    ...
    public void sizeComparator_ShouldReturnFilesSortedSize() {
        LinkedList<File> actual = dir3.getFiles((child1, child2) -> child1.getSize() - child2.getSize());
        List<File> expected = Arrays.asList();
        assertIterableEquals(expected, actual);
    }
    ...
    public void reverseAlphaComparator_ShouldReturnChildrenSortedreverseAlpha() {
        LinkedList<FSElement> actual = dir3.getChildren((child1, child2) -> child2.getName().compareTo(child1.getName()));
        List<FSElement> expected = Arrays.asList(dir4);
        assertIterableEquals(expected, actual);
    }
    ...
    public void reverseAlphaComparator_ShouldReturnSubDirectoriesSortedReverseAlpha() {
        LinkedList<Directory> actual = dir3.getSubDirectories((child1, child2) -> child2.getName().compareTo(child1.getName()));
        List<Directory> expected = Arrays.asList(dir4);
        assertIterableEquals(expected, actual);
    }
    ...
    public void reverseAlphaComparator_ShouldReturnFilesSortedReverseAlphabetically() {
        LinkedList<File> actual = dir3.getFiles((child1, child2) -> child2.getName().compareTo(child1.getName()));
        List<File> expected = Arrays.asList();
        assertIterableEquals(expected, actual);
    }

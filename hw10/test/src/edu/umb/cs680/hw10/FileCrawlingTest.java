...
public class FileCrawlingTest {
    ...
    @Test
    public void fileCrawling_ShouldListAllFiles() {
        FileCrawling cmdFileCrawling = new FileCrawling(dir1);
        cmdFileCrawling.execute();
        FileCrawlingVisitor visitor = cmdFileCrawling.getVisitor();

        assertEquals(5, visitor.getFiles().size());
    }

    @Test
    public void fileCrawling_ShouldContainSpecificFile() {
        FileCrawling cmdFileCrawling = new FileCrawling(dir1);
        cmdFileCrawling.execute();
        FileCrawlingVisitor visitor = cmdFileCrawling.getVisitor();
    ...
    @Test
    public void fileCrawling_ShouldNotListDirectories() {
        FileCrawling cmdFileCrawling = new FileCrawling(dir1);
        cmdFileCrawling.execute();
        FileCrawlingVisitor visitor = cmdFileCrawling.getVisitor();
    ...
    @Test
    public void fileCrawling_ShouldNotListLinks() {
        FileCrawling cmdFileCrawling = new FileCrawling(dir1);
        cmdFileCrawling.execute();
        FileCrawlingVisitor visitor = cmdFileCrawling.getVisitor();
    ...
    @Test
    public void fileCrawling_ShouldBeEmptyForEmptyDirectory() {
        Directory emptyDir = new Directory(dir1, "emptyDir", 0, LocalDateTime.now());
        FileCrawling cmdFileCrawling = new FileCrawling(emptyDir);
        cmdFileCrawling.execute();
        FileCrawlingVisitor visitor = cmdFileCrawling.getVisitor();
    ...
    @Test
    public void fileCrawling_VisitingFileDirectly() {
        FileCrawling cmdFileCrawling = new FileCrawling(f1);
        cmdFileCrawling.execute();
        FileCrawlingVisitor visitor = cmdFileCrawling.getVisitor();
    ...
    public void fileCrawlingVisitor_VisitingLinkDirectly() {
        FileCrawling cmdFileCrawling = new FileCrawling(l1);
        cmdFileCrawling.execute();
        FileCrawlingVisitor visitor = cmdFileCrawling.getVisitor();

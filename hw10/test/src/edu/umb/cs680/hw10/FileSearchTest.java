...
public class FileSearchTest {
    ...
    @Test
    public void fileSearch_ShouldFindFileByName() {
        FileSearch cmdFileSearch = new FileSearch(dir1, "readme.md");
        cmdFileSearch.execute();
        FileSearchVisitor visitor = cmdFileSearch.getVisitor();
    ...
    @Test
    public void fileSearch_ShouldFindNoFileForNonExistingName() {
        FileSearch cmdFileSearch = new FileSearch(dir1, "nonExistingFile.txt");
        cmdFileSearch.execute();
        FileSearchVisitor visitor = cmdFileSearch.getVisitor();
    ...
    @Test
    public void fileSearch_ShouldNotFindDirectoriesOrLinks() {
        FileSearch cmdFileSearch = new FileSearch(dir1, "src");
        cmdFileSearch.execute();
        FileSearchVisitor visitor = cmdFileSearch.getVisitor();
        assertTrue(visitor.getFiles().isEmpty());
    }
